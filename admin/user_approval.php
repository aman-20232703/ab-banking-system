...
<head>
  <meta charset="UTF-8">
  <title>Applications Awaiting Approval</title>
...
<body class="bg-gray-100 font-[Inter] p-8">
  <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold text-indigo-600 mb-6 text-center">Applications Awaiting Approval</h2>
        ...
        <tbody class="text-gray-800">
          ...
          <tr class="hover:bg-gray-50 border-t">
            ...
            <td class="px-4 py-3 text-center">
              <a href="approve.php?mobile=<?= urlencode($row['mobile']) ?>" 
                 class="inline-block px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded transition">
                 View & Approve
              </a>
            </td>
          </tr>
